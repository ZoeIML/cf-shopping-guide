...
var shopData = __webpack_require__(37);
...
var _ListShops = __webpack_require__(22);

var _ListShops2 = _interopRequireDefault(_ListShops);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var productData = __webpack_require__(85);
...
module.exports = {
    shops: [{
        ...
        products: ['Sukin Cleanser', 'Honey Cleanser']
    }, {
        id: 2,
        name: 'Lush',
        ...
        city: 'Auckland',
        url: 'www.lush.co.nz',
        products: ['Aqua Marina', 'Lord of Misrule']
    }, {
        id: 3,
        ...
        products: ['Test Mascara', 'Go Cleanser']
    }]
};
...
var _HomeInfo = __webpack_require__(80);
...
var _ListCities = __webpack_require__(84);
...
var _ListShopsByProduct = __webpack_require__(88);

var _ListShopsByProduct2 = _interopRequireDefault(_ListShopsByProduct);

var _ListProducts = __webpack_require__(36);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.state = {};
    _this.renderMapTile = _this.renderMapTile.bind(_this);
    return _this;
  }

  _createClass(App, [{
    key: 'renderMapTile',
    value: function renderMapTile(map) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/maps', render: function render() {
                return _react2.default.createElement(_TheMap2.default, {
                  renderMapTile: _this2.renderMapTile });
              } }),
...
var ListShopsByProduct = function ListShopsByProduct(props) {
    var city = props.match.params.city;
    var neededProduct = props.match.params.product;
    var chosenShop = shopData.shops.find(function (shop) {
    ...
    return _react2.default.createElement(
        ...
        shopData.shops.map(function (shop) {
            if (shop.products.find(function (product) {
                return product === neededProduct;
            }) === neededProduct) {
                return _react2.default.createElement(
                    'div',
                    { className: 'shop-listing', key: shop.id },
                    _react2.default.createElement(
                        'div',
                        { className: 'shop-name' },
                        shop.name
...
exports.default = ListShopsByProduct;
...
var apiURL = 'http://localhost:300/api/v1/apiserver';
...
var Agent = __webpack_require__(99);
